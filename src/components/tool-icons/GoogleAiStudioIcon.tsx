type GoogleAiStudioIconProps = {
  className?: string;
  title?: string;
};

/** Google AI Studio mark — uses currentColor for light/dark theme. */
export function GoogleAiStudioIcon({ className, title = 'Google AI Studio' }: GoogleAiStudioIconProps) {
  return (
    <svg
      fill="currentColor"
      fillRule="evenodd"
